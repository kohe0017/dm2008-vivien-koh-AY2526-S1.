...
function keyPressed() {
  ...
  if ((key === "C") | (key === "c")) {
    strokeWeight (1);
  stroke(random(10,100), random(10, 100), random(255));
    }
  ...
  let speedX = random(-2, 2);
  let speedY = random(-2, 2);
   agents.push(new Agent(mouseX, mouseY, sz/2, speedX*2, speedY*2));
  }
...
/* ============================
   ...
   - Make one property evolve over time (sz, hue, alpha, speed)
