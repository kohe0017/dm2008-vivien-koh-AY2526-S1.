...
function preload() {
  jumpSound = loadSound("meow.mp3");
  scoreSound = loadSound("ping.mp3");
...
//       noLoop();
  ...
  show() {
    ...
    circle(this.pos.x + 6, this.pos.y - 4, 4);
     ...
     fill('#A86510');
    triangle (this.pos.x - this.r, this.pos.y - 5, this.pos.x - this.r -5, this.pos.y - 20, this.pos.x - 4, this.pos.y -15);
    triangle (this.pos.x + this.r, this.pos.y - 5, this.pos.x + this.r + 5, this.pos.y - 20, this.pos.x + 4, this.pos.y -15);
...
class Pipe {
  ...
  hits(bird) {
   ...
   // const belowFloor = bird.pos.y + bird.r >= height;
  }
}
